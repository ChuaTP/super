# ============================================================
# HEART FAILURE PREDICTION — SUPPORT VECTOR MACHINE (SVM)
...
# Output     : svm_model.pkl  (model + scaler saved for Streamlit)
# ============================================================
...
# ─────────────────────────────────────────────
print("=" * 65)
print("  SVM — HEART FAILURE PREDICTION")
print("=" * 65)
...
param_order = ["C", "class_weight", "degree", "gamma", "kernel"]
...
if gap <= 3:
    ...
    print(f"    Verdict : Acceptable, consider using balanced class_weight or lower C")
else:
    print(f"    Result  : SIGNIFICANT overfitting detected (gap = {gap:.2f}%)")
    print(f"    Verdict : Model memorised training data — reduce C or switch kernel")
...
fig.suptitle("SVM — Heart Failure Prediction Results",
...
bar_colors    = ["#7F77DD", "#1D9E75", "#185FA5", "#D85A30", "#BA7517"]
...
plt.show()
print(f"    Saved -> svm_results.png")

# ─────────────────────────────────────────────
# 11. SUMMARY TABLE
# ─────────────────────────────────────────────
print(f"\n{'=' * 65}")
print(f"  SVM MODEL — FINAL SUMMARY")
print(f"{'=' * 65}")
...
joblib.dump(model_data, "svm_model.pkl")

print(f"    Saved -> svm_model.pkl")
print(f"\n{'=' * 65}")
print(f"  Output files:")
print(f"    svm_model.pkl    — model + scaler for Streamlit")
print(f"    svm_results.png  — confusion matrix, ROC, metrics")
print(f"{'=' * 65}")